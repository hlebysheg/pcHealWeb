import axios, { HeadersDefaults } from "../../../node_modules/axios/index";


const axiosClient = axios.create();

// Replace this with our own backend base URL
axiosClient.defaults.baseURL = import.meta.env.URL;
...
axiosClient.interceptors.response.use(
  ...
  async err => {
    ...
    if (!originalConfig.url.includes('log') && err.response) {
